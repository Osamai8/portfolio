  ...
  return (
    ...
    >
      <div className='relative w-full md:w-3/5'>
        <img src={image} alt="open-icon" className="w-full h-auto object-cover md:rounded-3xl" />
      </div>

      <div className={`w-full md:w-2/5 px-6 md:px-16 flex flex-col justify-center ${isEven ? "text-left md:text-left" : "text-left md:text-right"}`}>
        ...
        <a href={url} target="_blank">
          <u className="text-[#F55F17] underline cursor-pointer italic text-sm sm:text-xs md:text-sm lg:text-md xl:text-lg 2xl:text-xl">Explore</u>
        </a>
      </div>
    </motion.div>
  );
